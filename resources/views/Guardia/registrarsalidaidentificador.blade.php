...
@section('title', 'Registrar Salida por Identificador')
...
<div class="container-fluid d-flex justify-content-center align-items-center vh-100">
    ...
    <div class="text-center">
        <h1 class="mb-4">Registrar Salida por Identificador</h1>
        ...
        <div class="btn-group mt-4 d-flex flex-column align-items-center">
            <a href="{{ route('guardia.registrarsalida') }}" class="btn btn-custom">Volver a Registro de Salida</a>
